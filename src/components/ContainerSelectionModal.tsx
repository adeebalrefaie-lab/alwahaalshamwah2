        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="p-8 space-y-10">
              <div>
                <h3 className="text-2xl font-bold text-coffee mb-6 text-center">
                  العلب
                </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {boxes.map((container) => (
                    <motion.button
                      ...
                      className="relative p-6 bg-cream-100 rounded-xl shadow-md hover:shadow-xl transition-all border-2 border-brown-400 hover:border-brown-600 text-right"
                    >
                      <h4 className="text-xl font-bold text-coffee mb-3">
                        {container.nameAr}
                      </h4>

                      <p className="text-lg text-brown-700 mb-4 font-semibold">
                        {container.heightCm} × {container.widthCm} cm
                      </p>

                      <p className="text-sm text-brown-600 leading-relaxed">
                        سعر علبة فارغة: <span className="font-bold text-brown-800 text-base">{container.basePriceJOD.toFixed(2)} دينار</span>
                      </p>
                    </motion.button>
                  ))}
                </div>
              ...
              <div className="border-t-2 border-brown-400 pt-8">
                <h3 className="text-2xl font-bold text-coffee mb-6 text-center">
                  الصحون
                </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {trays.map((container) => (
                    <motion.button
                      ...
                      className="relative p-6 bg-cream-100 rounded-xl shadow-md hover:shadow-xl transition-all border-2 border-brown-400 hover:border-brown-600 text-right"
                    >
                      <h4 className="text-lg font-bold text-coffee mb-3">
                        {container.nameAr}
                      </h4>

                      <p className="text-base text-brown-700 font-semibold">
                        {container.heightCm} × {container.widthCm} cm
                      </p>
                    </motion.button>
                  ))}
